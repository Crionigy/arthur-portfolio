...
export default class Camera {
    ...
    constructor() {
        ...
        if(this.debug.active) {
            ...
            this.positionDebugFolder.add(this.instance.position, 'z', -20, 20, 0.1)
    ...
    setInstance() {
        this.instance = new THREE.PerspectiveCamera(75, this.sizes.width / this.sizes.height, 0.4, 500)
